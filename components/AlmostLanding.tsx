...
const TOP_CITIES = [
  ...
  "Osaka","Karachi","Chongqing","Istanbul","Buenos Aires","Kolkata","Kinshasa","Lagos",
  "Manila","Tianjin","Guangzhou","Rio de Janeiro","Lahore","Bangalore","Moscow","Shenzhen",
  "Chennai","Jakarta","Lima","Bangkok","Hyderabad","Seoul","Nagoya","Chengdu","Nanjing",
  "Tehran","Ho Chi Minh City","Bogotá","Dongguan","Hong Kong","Ahmedabad","Kuala Lumpur",
  "Hangzhou","Wuhan","Riyadh","Suzhou","Santiago","Baghdad","Surat","Yangon",
  "Dar es Salaam","Alexandria","Luanda","Abidjan","Casablanca","Pune","Addis Ababa",
  "Accra","Havana","Toronto","Johannesburg","Nairobi","Khartoum","Harbin","New York",
  "Los Angeles","Chicago","Houston","London","Paris","Madrid","Rome","Berlin","Sydney",
  "Melbourne","Amsterdam","Brussels","Vienna","Warsaw","Stockholm","Oslo","Copenhagen",
  "Helsinki","Lisbon","Zurich","Barcelona","Milan","Munich","Hamburg","Frankfurt","Athens",
  "Dubai","Singapore","Taipei","Auckland","Cape Town","Montreal","Vancouver",
  "San Francisco","Miami","Seattle","Boston","Washington D.C.","Dallas","Phoenix","Other",
];
    ...
    <div style={{ background: "#b9b9b9", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <div style={{ position: "relative", width: "100%", paddingBottom: "56.25%", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0 }}>
          ...
          {/* Background image — pink at top, grey at bottom */}
          <img
          ...
          {/* Bouncing faces — above background */}
          <div style={{
          ...
          {/* Logo — white, above faces */}
          <div style={{
            position: "absolute", top: "42%", left: "50%",
            transform: "translate(-50%, -50%)",
            width: "60%", maxWidth: 700, zIndex: 20,
          }}>
      ...
      <div style={{ maxWidth: 441, margin: "0 auto", padding: "60px 40px 80px", boxSizing: "border-box" }}>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {/* City field with datalist + chevron */}
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    ...
                    padding: "0 40px 0 16px", height: 50,
                    fontFamily: "system-ui, -apple-system, sans-serif",
                ...
                <datalist id="city-list">
                  {TOP_CITIES.map(c => <option key={c} value={c} />)}
                </datalist>
                {/* Chevron */}
                <svg
                ...
                >
                  <path d="M1 1L6 6L11 1" stroke="#2c2c2c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
